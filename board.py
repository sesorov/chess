...
from pieces import Piece, PieceType, PieceFactory
from structs import ChessPosition, MoveCommand
...
INITIAL_PIECE_SET_SINGLE = [
    ...
    (PieceType.SUPERBISHOPKNIGHT, 2, 0),
    (PieceType.BISHOP, 3, 0),
    (PieceType.QUEEN, 4, 0),
    (PieceType.KING, 5, 0),
    (PieceType.BISHOP, 6, 0),
    (PieceType.SUPERBISHOPKNIGHT, 7, 0),
